...
Release build passed with 17 existing unassigned-field warnings and no errors. All FC manual examples and standalone hello/entity builds passed.
...
Compiler C# files, app.config and the project file now live in `kitaqfc/`.
