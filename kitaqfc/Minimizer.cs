...
// Usage:
// kitaqfc foo.c -o out.gb --minimize
// kitaqfc foo.c bar.c -o out.gb --minimize=foo.c
// kitaqfc foo.c -o out.gb --minimize --minimize-out=foo.min.c
// Notes:
    ...
    private static string ExtractFingerprint(string output)
    {
        ...
        using (var sr = new StringReader(output))
        {
            ...
            while ((line = sr.ReadLine()) != null)
            {
                ...
                // Skip banner
                if (line.StartsWith("[kitaqfc]")) continue;
